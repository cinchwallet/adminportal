...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left">Create New Offer</div>
		...
		<!-- start id-form -->
		<c:url var="saveUrl" value="/offer/save" />
		<form:form modelAttribute="offer" name="form" method="POST" action="${saveUrl}">
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		
		<tr>
			<th valign="top"><spring:message code="offer.label.name"/></th>
			<td><form:input path="name" class="inp-form" /></td>
			<td></td>
			<form:hidden path="uid"/>
		</tr>
		<tr>
			<th valign="top"><spring:message code="offer.label.upc"/></th>
			<td>
		...
		<tr>
			<th valign="top"><spring:message code="offer.label.description"/></th>
			<td><form:input path="description" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top"><spring:message code="offer.label.promocode"/></th>
			<td><form:input path="promoCode" class="inp-form" /></td>
			<td></td>
		</tr>
		<tr>
			<th valign="top"><spring:message code="offer.label.promorule"/></th>
			<td><form:input path="promoRule" class="inp-form" /></td>
			<td></td>
		</tr>
