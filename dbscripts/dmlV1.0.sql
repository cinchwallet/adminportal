...
INSERT INTO cw_admin.user (UID, FIRST_NAME, LAST_NAME, ADDRESS, CITY, PIN, STATE, COUNTRY, PHONE, EMAIL, STATUS, CREATED_TIMESTAMP, UPDATED_TIMESTAMP)VALUES(1, 'Manoj', 'Singh', '', '', '', '', '', '', '', 0, now(), now());
