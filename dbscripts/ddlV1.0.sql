...
CREATE TABLE CARD_PRODUCT (
  ...
  EARN_POINT_RULE VARCHAR(20) DEFAULT NULL, 
  BURN_POINT_RULE VARCHAR(20) DEFAULT NULL, 
...
CREATE TABLE CARD (
  ...
  POINTS_EXPIRE_ON DATE  DEFAULT NULL,
...
CREATE TABLE PROMOTIONAL_OFFER (
  ...
  DESCRIPTION VARCHAR(50) DEFAULT NULL,
  CARD_PRODUCT VARCHAR(20) NOT NULL,
  PROMO_RULE VARCHAR(20) NOT NULL,
